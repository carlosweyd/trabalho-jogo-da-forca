// variables
let words = ['falcao', 'jumper', 'djoes', 'rambo', 'titanic', 'deadpool', 'godzila', 'kong', 'rampage', 'tubarao', 'batmam', 'panico', 'logan', 'venon', 'transformers', 'coringa', 'alien', 'interestelar', 'superman', 'battleship', 'predador', 'terremoto', 'wolverine', 'aquamam', 'thor', 'avatar', 'dracula', 'matrix'];
let chosenWord;
let correctWord = "";
let letters = [];
let tries = 10;
